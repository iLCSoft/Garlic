#ifndef GARLICGEOMETRYPARAMS_HH_
#define GARLICGEOMETRYPARAMS_HH_
...
class GarlicGeometryParameters {

public:

  static GarlicGeometryParameters& Instance() {
    static GarlicGeometryParameters geompars;
    return geompars;
  }
...
private:
  ...
  GarlicGeometryParameters() {init();}

  GarlicGeometryParameters (const GarlicGeometryParameters&);
  GarlicGeometryParameters& operator= (const GarlicGeometryParameters&);
