...
class GarlicGeometryHelpers {

public:

  GarlicGeometryHelpers () {}
...
public:
  ...
  void getFrontFaceProj(const float* a, const float* dir, float* proj);
...
protected:
  ...
  void  getLineCircleIntersection( const float* aPoint, const float* aDir, float radius, float* intersec1, float* intersec2 );
  void  getLineCylinderIntersection( const float* aPoint, const float* aDir, float radius, float* intersec1, float* intersec2 );
